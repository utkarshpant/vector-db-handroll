...
from sdk.LibraryClient import LibraryClient
...
async def main():
    ...
    client = LibraryClient(base_url="http://localhost:8000")
    lib_id = await client.create_library(
        name="Demo Library", metadata={"purpose": "demo"}, index_name=IndexName.BallTreeIndex.value)
    ...
    await client.upsert_chunks(library_id=lib_id['id'], chunks=chunks)
